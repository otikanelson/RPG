...
function buyHealth() {
    if (gold >= 10) {
        ...
        text.innerText = "You stare at the green bottle on the top most shelf. And the shop keep offers it to you and opens up his wretched hands. Your check you belt pockets and bring out three gold coins, he immediately snatches it from you mitts and scurries along.", text, 30;
    } else {
        text.innerText = "You do not seem to have enough gold for this adventurer!!?? The previously grinning shop keep yells almost concerned";
